...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pokemonService = __webpack_require__(3);

	window.app = {
	    addPokemon: _pokemonService.getPokemons
	};

	(0, _pokemonService.getPokemons)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.addPokemon = exports.getPokemons = undefined;
	...
	var addPokemon = exports.addPokemon = function () {
	            ...
	            while (1) {
	                switch (_context2.prev = _context2.next) {
	                    ...
	                    case 2:
	                        ...
	                        index = lastIndexSaved + 1;

	                        fetch(baseURL + resourceType + "/" + index).then(function (data) {
	                            return data.json();
	                        }).then(function (data) {
	                            (0, _userStorage.addPokemonToIndexedDB)(data);
	    ...
	    return function addPokemon() {
	        return _ref2.apply(this, arguments);
	    };
	}();

	var _userStorage = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getPokemonsFromIndexedDB = undefined;

	var getLatestPokemonSavedFromIndexedDB = function () {
	    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	        var keys;
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    case 0:
	                        _context.prev = 0;
	                        _context.next = 3;
	                        return pokedexInstance.keys();

	                    case 3:
	                        keys = _context.sent;
	                        return _context.abrupt('return', keys[keys.length - 1]);

	                    case 7:
	                        _context.prev = 7;
	                        _context.t0 = _context['catch'](0);

	                        console.error('Error ocurred when fetching latest index saved' + _context.t0);
	    ...
	    return function getLatestPokemonSavedFromIndexedDB() {
	        return _ref.apply(this, arguments);
	    };
	}();

	var getPokemonFromIndexedDB = function () {
	            ...
	            while (1) {
	                switch (_context2.prev = _context2.next) {
	                    case 0:
	                        _context2.prev = 0;
	                        _context2.next = 3;
	                        return pokedexInstance.getItem(index);
	                    ...
	                    case 7:
	                        ...
	                        console.error('Error fetching pokemon from DB' + _context2.t0);
	    ...
	    return function getPokemonFromIndexedDB(_x) {
	        return _ref2.apply(this, arguments);
	    };
	}();

	var getPokemonsFromIndexedDB = exports.getPokemonsFromIndexedDB = function () {
	    var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
	        var collection, lastIndex, i, pokemon;
	            ...
	            while (1) {
	                switch (_context3.prev = _context3.next) {
	                    case 0:
	                        collection = [];
	                        _context3.next = 3;
	                        return getLatestPokemonSavedFromIndexedDB();

	                    case 3:
	                        lastIndex = _context3.sent;
	                        i = 0;
	                    ...
	                    case 5:
	                        ...
	                        _context3.next = 8;
	                        return getPokemonFromIndexedDB(i);
	                    ...
	                    case 13:
	                        return _context3.abrupt('return', Promise.all(collection));
	    ...
	    return function getPokemonsFromIndexedDB() {
	        return _ref3.apply(this, arguments);
	    };
	}();

	exports.addPokemonToIndexedDB = addPokemonToIndexedDB;
	...
	function addPokemonToIndexedDB(pokemon) {
	    var id = pokemon.id,
	        name = pokemon.name,
	        image = pokemon.image,
...
/***/ function(module, exports) {
	...
	var appendPokemons = exports.appendPokemons = function appendPokemons(pokemons) {
	    var cardHTML = "";
	...
	var generateCarCards = function generateCarCards(pokemon) {
